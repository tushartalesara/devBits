...
const Crypto = (props) => {
  ...
  const handleSell=(e)=>{
    ...
    axios.post(`http://localhost:5000/api/sell/crypto/${props.symbol}`,{
  ...
  const handleBuy=(e)=>{
    ...
    axios.post(`http://localhost:5000/api/buy/crypto/${props.symbol}`,{
  ...
  return (
    <div className="stock">
      ...
      <h3 className="card-item-change-percentage">Change Percentage: {props.change}%</h3>
