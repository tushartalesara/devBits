...
const AboutUs = () => {
  return (
    <div className='aboutUs' id='aboutUs'>
        <h1>About Us</h1>
        <p>
            Welcome to our website,where we provide a financial environment to our clients. This will help them to develop their understanding about different types of financial activities.
            <br />
            <br />
